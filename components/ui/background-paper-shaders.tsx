...
// Canvas-wrapped background for use outside r3f context
export function ShadersBackground({
  ...
  return (
    <Canvas camera={{ position: [0, 0, 3], fov: 60 }}>
      ...
      <ShaderPlane position={[-1.5, 0.5, -1]} color1={color2} color2={color1} />
      <ShaderPlane position={[1.5, -0.5, -1]} color1={color1} color2={color2} />
      <EnergyRing radius={1.2} position={[0, 0, 0.5]} />
      <EnergyRing radius={0.7} position={[1.2, 0.3, -0.3]} />
    </Canvas>
  );
}
