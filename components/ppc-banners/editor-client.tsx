    ...
    <div className="flex h-screen flex-col overflow-hidden bg-slate-50">
      <div className="flex h-14 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4">
        <div className="flex items-center gap-3">
          ...
          <Input value={banner.name} onChange={(e) => onBannerChange("name", e.target.value)} className="h-8 w-56 border-none shadow-none text-sm font-semibold focus-visible:ring-1" />
        </div>
        <Button onClick={save} size="sm" disabled={saving} className={saved ? "bg-emerald-600 hover:bg-emerald-700" : "bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700"}>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="hidden w-60 shrink-0 overflow-y-auto border-r border-slate-200 bg-white p-3 md:block">
