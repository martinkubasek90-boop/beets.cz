...
export const defaultPlannerContent: PlannerContent = {
  months: {
    "2024": {
      ...
      currentIndicatorTop: 264,
      events: [
        { id: "2024-1", title: "Sběr podnětů z Vimperka a mapování hlavních problémů", timeLabel: "LEDEN - BŘEZEN", top: 6, height: 132 },
        { id: "2024-2", title: "První konkrétní návrhy k bydlení a centru města", timeLabel: "KVĚTEN - ČERVENEC", top: 198, height: 132 },
        { id: "2024-3", title: "Ujasnění hlavní linky kampaně a lokálních témat", timeLabel: "ZÁŘÍ - LISTOPAD", top: 390, height: 132 },
      ],
      tasks: [
    ...
    "2025": {
      ...
      dayTitle: "2025",
      dateSubtitle: "leden až prosinec",
      currentIndicatorTop: 312,
      events: [
        { id: "2025-1", title: "Setkávání s podnikateli, rodinami a lidmi z centra", timeLabel: "ÚNOR - DUBEN", top: 54, height: 132 },
        { id: "2025-2", title: "Příprava veřejných výstupů k dopravě a bydlení", timeLabel: "ČERVEN - SRPEN", top: 246, height: 132 },
        { id: "2025-3", title: "Rozšíření online komunikace a lokální viditelnosti", timeLabel: "ŘÍJEN - PROSINEC", top: 438, height: 132 },
      ],
      tasks: [
    ...
    "2026": {
      ...
      dayTitle: "2026",
      dateSubtitle: "leden až prosinec",
      currentIndicatorTop: 294,
      events: [
        { id: "2026-1", title: "Viditelně otevřít témata dopravy, centra a bydlení", timeLabel: "LEDEN - BŘEZEN", top: 6, height: 132 },
        { id: "2026-2", title: "Přetavit program do srozumitelných výstupů pro veřejnost", timeLabel: "KVĚTEN - ČERVENEC", top: 198, height: 132 },
        { id: "2026-3", title: "Finální terénní i online kampaň před komunálními volbami", timeLabel: "ZÁŘÍ - LISTOPAD", top: 390, height: 132 },
      ],
      tasks: [
    ...
    "2027": {
      ...
      dayTitle: "2027",
      dateSubtitle: "leden až prosinec",
      currentIndicatorTop: 342,
      events: [
        { id: "2027-1", title: "Ukázat první výsledky a viditelné kroky pro město", timeLabel: "ÚNOR - DUBEN", top: 54, height: 132 },
        { id: "2027-2", title: "Držet vysokou frekvenci komunikace s občany", timeLabel: "ČERVEN - SRPEN", top: 246, height: 132 },
        { id: "2027-3", title: "Zpracovat zpětnou vazbu a upravit priority další práce", timeLabel: "ŘÍJEN - PROSINEC", top: 438, height: 132 },
      ],
      tasks: [
    ...
    "2028": {
      ...
      dayTitle: "2028",
      dateSubtitle: "leden až prosinec",
      currentIndicatorTop: 438,
      events: [
        { id: "2028-1", title: "Vyhodnotit, co se podařilo opravdu změnit v praxi", timeLabel: "LEDEN - BŘEZEN", top: 6, height: 132 },
        { id: "2028-2", title: "Posunout další projekty k bydlení, centru a kvalitě života", timeLabel: "KVĚTEN - SRPEN", top: 198, height: 180 },
        { id: "2028-3", title: "Připravit další dlouhodobou vizi rozvoje Vimperka", timeLabel: "ŘÍJEN - PROSINEC", top: 438, height: 132 },
      ],
      tasks: [
