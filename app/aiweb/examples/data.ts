...
export const EXAMPLES: ExampleSite[] = [
  {
    ...
    description: 'Ukázka webu pro restauraci, bistro nebo gastropodnik, který chce působit profesionálně a sbírat rezervace online.',
  ...
  },
  {
    ...
    description: 'Ukázka webu pro fitness studio, osobního trenéra nebo sportovní koncept, který potřebuje prodávat členství a lekce.',
  ...
  },
  {
    ...
    description: 'Ukázka webu pro makléře nebo realitní kancelář, která chce důvěryhodně prezentovat nabídku a sbírat poptávky.',
  ...
  },
  {
    ...
    description: 'Ukázka webu pro kavárnu nebo coffee concept, který chce ukázat atmosféru, menu i lokaci v jednotném stylu.',
  ...
  {
    slug: 'graficke-studio',
    industry: 'Grafické studio',
    name: 'Grafické studio',
    tagline: 'Template pro branding, design a vizuální identitu',
    description: 'Ukázka webu pro grafické studio, kreativce nebo branding tým, který chce působit čistě a sebevědomě.',
    bg: '#080808', surface: '#0f0f0f', primary: '#f8fafc', primaryLight: '#ffffff',
    text: '#f8fafc', textMuted: '#475569', border: 'rgba(248,250,252,0.1)',
    heroLabel: 'Template pro kreativní služby',
    heroH1: ['Design, který', 'dává značce', 'jasný tvar'],
    heroSub: 'Template ukazuje, jak může grafické studio prezentovat služby, portfolio, proces i osobitý vizuální rukopis.',
    heroCta: 'Zahájit projekt',
    heroCtaSecondary: 'Portfolio',
    sections: [
      { type: 'features', label: 'Služby', title: 'Co navrhujeme', items: [
        { icon: '🎨', title: 'Brand identita', desc: 'Logo, barevnost, typografie a vizuální systém značky v jednom rámci.' },
        { icon: '🧩', title: 'Grafické výstupy', desc: 'Web, sociální sítě, tiskoviny nebo prezentační materiály v jednotném stylu.' },
        { icon: '🖼️', title: 'Portfolio a case studies', desc: 'Sekce pro ukázky práce, proměny značky nebo výsledky spolupráce.' },
        { icon: '📐', title: 'Proces spolupráce', desc: 'Jasné vysvětlení postupu od briefu po předání finálních podkladů.' },
      ]},
    ...
    footerTagline: 'Template pro grafické studio · Portfolio · Proces · Kontakt',
  ...
  },
  {
    ...
    description: 'Ukázka webu pro zubní ordinaci nebo kliniku, která chce působit klidně, důvěryhodně a profesionálně.',
  ...
  },
  {
    ...
    description: 'Ukázka webu pro startup nebo software produkt, který potřebuje vysvětlit hodnotu a konvertovat demo poptávky.',
