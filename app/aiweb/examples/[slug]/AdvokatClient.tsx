    ...
    <div style={{ background: s.bg, minHeight: '100vh', color: s.text, fontFamily: 'var(--font-geist-sans, system-ui, sans-serif)' }}>
      ...
      <section style={{ padding: '80px 24px', background: s.surface }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <p style={{ color: s.primary, fontSize: 12, fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', marginBottom: 10 }}>Reference</p>
            <h2 style={{ fontSize: 'clamp(24px, 4vw, 44px)', fontWeight: 900, letterSpacing: '-1px', margin: 0, color: s.text }}>Co říkají naši klienti</h2>
            <p style={{ color: s.textMuted, fontSize: 16, margin: '12px 0 0' }}>Více než 500 úspěšně vyřešených případů</p>
          </div>
          <TestimonialCarousel
      ...
      <section id="kontakt" style={{ padding: '80px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 560, margin: '0 auto' }}>
          ...
          <p style={{ color: s.textMuted, fontSize: 16, marginBottom: 36, lineHeight: 1.7 }}>První konzultace je vždy zdarma. Ozvěte se nám.</p>
          {btn(s.heroCta)}
        </div>
      </section>
