                  ...
                  <div className="w-full rounded-2xl border border-white/10 bg-black/40 p-3">
                    {!hasAccess ? (
                      ...
                      >
                        ...
                        <div className="mt-6 w-full rounded-lg border border-white/10 bg-black/40 p-3 text-left">
                          <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--mpc-muted)] mb-2">
                            Tracklist
                          </p>
                          {tracks.length > 0 ? (
